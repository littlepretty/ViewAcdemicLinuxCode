...
struct fix
{
...
#ifdef TC_NS32K
  /* The ns32k needs a 3 valued field here. This could no doubt be
     satisfied by the tx_fix_data below.  */
  unsigned fx_im_disp : 2;
#else
  unsigned fx_im_disp : 1;
#endif

  /* This is a hack for the sequent support.
  ...
  /* Location where a backend can attach additional data
     needed to perform fixups.  Used by both PA backends.  */
  PTR tc_fix_data;
};
