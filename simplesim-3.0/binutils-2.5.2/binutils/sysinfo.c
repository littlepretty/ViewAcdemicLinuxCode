...
/*  A Bison parser, made from ./sysinfo.y with Bison version GNU Bison version 1.22
  */
...
static const short yyprhs[] = {     0,
    ...
    64,    68,    69,    70,    74,    75,    81
};

static const short yyrhs[] = {    -1,
    14,    15,     0,    16,    15,     0,     0,     0,     5,    10,
    11,    17,    18,     6,     0,    23,    18,     0,    21,    18,
     0,    19,    18,     0,     0,     0,     5,     4,    10,    20,
    18,     6,     0,     0,     5,     3,    10,    22,    18,     6,
     0,     0,     5,    26,     5,    25,    27,     6,    28,    24,
    29,     6,     0,     9,     0,     0,     5,    10,     6,     0,
    11,    12,     0,     5,    10,     6,     0,     0,     0,     5,
    30,     6,     0,     0,    30,     5,    10,    10,     6,     0,
    10,     0
};
...
static const short yyrline[] = { 0,
   ...
   354,   356,   359,   360,   362,   363,   380
};

static const char * const yytname[] = {   "$","error","$illegal.","COND","REPEAT",
"'('","')'","'['","']'","TYPE","NAME","NUMBER","UNIT","top","@1","it_list","it",
"@2","it_field_list","repeat_it_field","@3","cond_it_field","@4","it_field",
"@5","attr_type","attr_desc","attr_size","attr_id","enums","enum_list",""
};
#endif

static const short yyr1[] = {     0,
    14,    13,    15,    15,    17,    16,    18,    18,    18,    18,
    20,    19,    22,    21,    24,    23,    25,    25,    26,    27,
    28,    28,    29,    29,    30,    30,    -1
};
...
static const short yypact[] = {-32768,
     3,    -1,-32768,     3,     2,-32768,-32768,     5,     0,     6,
     5,     5,     5,     4,     7,     8,    14,-32768,-32768,-32768,
-32768,-32768,-32768,    15,    11,     5,     5,-32768,-32768,    12,
    16,    18,    13,    20,-32768,-32768,-32768,    22,    19,-32768,
    24,    23,-32768,-32768,    25,     1,-32768,    26,-32768,    27,
    28,-32768,    32,    33,-32768
};

static const short yypgoto[] = {-32768,
-32768,    31,-32768,-32768,   -11,-32768,-32768,-32768,-32768,-32768,
...
static const short yytable[] = {    19,
    20,    21,    14,    15,    16,    48,    49,     2,     5,     9,
     0,    18,     7,    22,    31,    32,    23,    24,    25,    29,
    28,    35,    33,    36,    37,    38,    39,    44,    41,    43,
    47,    54,    55,    52,     6,    50,    51
};

static const short yycheck[] = {    11,
    12,    13,     3,     4,     5,     5,     6,     5,    10,     5,
    -1,     6,    11,    10,    26,    27,    10,    10,     5,     9,
     6,     6,    11,     6,    12,     6,     5,     5,    10,     6,
     6,     0,     0,     6,     4,    10,    10
};
