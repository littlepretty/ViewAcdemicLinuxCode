...
.       asection **sections));
. const struct reloc_howto_struct *(*_bfd_coff_rtype_to_howto) PARAMS ((
.       bfd *abfd,
.       asection *sec,
...
static const struct reloc_howto_struct *coff_rtype_to_howto
...
static CONST bfd_coff_backend_data bfd_coff_std_swap_table =
{
  ...
  coff_relocate_section, coff_rtype_to_howto
};
