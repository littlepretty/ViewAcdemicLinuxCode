...
bfd_reloc_status_type
  ns32k_reloc_imm  PARAMS ((bfd *abfd,
		   ...
		   bfd *output_bfd,
		   char **error_message));
bfd_reloc_status_type ns32k_final_link_relocate  PARAMS (( const reloc_howto_type *howto,
			     bfd *input_bfd,
			     asection *input_section,
			     bfd_byte *contents,
			     bfd_vma address,
			     bfd_vma value,
			     bfd_vma addend ));
bfd_reloc_status_type ns32k_relocate_contents  PARAMS ((const reloc_howto_type *howto,
							bfd *input_bfd,
							bfd_vma relocation,
							bfd_byte *location));
