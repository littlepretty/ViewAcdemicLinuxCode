 ...
 * those blocks and outputs the best thermally-aware floorplan
 * it can find.
 */
#include <stdio.h>
#include <string.h>
...
void usage(int argc, char **argv)
{
	...
	fprintf(stdout, "   -f <file>\tfloorplan description input file\n");
	fprintf(stdout, "   -p <file>\tpower input file\n");
...
void print_wire_delays(flp_t *flp, double frequency)
{
	...
	fprintf(stdout, "(in %.1lf GHz cycles)\n", frequency / 1.0e9);
